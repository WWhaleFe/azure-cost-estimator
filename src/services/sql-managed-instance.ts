...
import type { Row, ApiItem, SpPair } from '../core/kernel.js';
// ================================================================
...
var _SQLMI_PRODUCT: Record<string, string> = {
...
var _SQLMI_LICENSE_USD: Record<string, number> = { 'General Purpose': 0.10, 'Business Critical': 0.375 };
...
REG['_buildDetail_Azure_SQL_Managed_Instance'] = function(r: Row) {
  var o = r.options || {};
...
REG['_resolve_Azure_SQL_Managed_Instance'] = async function(row: Row, cur: string) {
  var o = row.options || {};
  ...
  function addLic(it: any){ if(!it || licAddon<=0) return it; var p=Number(it.unitPrice)+licAddon; return Object.assign({}, it, {unitPrice:p, retailPrice:p, _sqlLicAddon:licAddon}); }
