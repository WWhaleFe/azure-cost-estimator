...
REG._svcDefs['App Service'] = {
  ...
  _applyStepVisibility: function(r){ if (REG['_appsvc_applyStepVisibility']) REG['_appsvc_applyStepVisibility'](r); },
};

REG['_appsvc_applyStepVisibility'] = function(r) {
...
REG['_buildDetail_App_Service'] = function(r) {
  var o = r.options || {};
...
REG['_resolve_App_Service'] = async function(row, cur) {
  var o = row.options || {};
