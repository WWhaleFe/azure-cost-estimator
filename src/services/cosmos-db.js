...
REG._svcDefs['Azure Cosmos DB'] = {
  ...
  _applyStepVisibility: function(r){ if (REG['_cosmos_applyStepVisibility']) REG['_cosmos_applyStepVisibility'](r); },
};

// RU/s 입력은 Provisioned/Autoscale에서만 사용
REG['_cosmos_applyStepVisibility'] = function(r) {
...
REG['_buildDetail_Azure_Cosmos_DB'] = function(r) {
  var o = r.options || {};
...
REG['_resolve_Azure_Cosmos_DB'] = async function(row, cur) {
  var o = row.options || {};
