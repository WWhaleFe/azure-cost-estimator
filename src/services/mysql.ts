...
var _MYSQL_PRODUCT: Record<string,string> = {
...
var _MYSQL_RESV_PRODUCT: Record<string,string> = {
...
var _MYSQL_GP_GEN: Record<string,string> = { 'Ddsv5':'Ddsv5', 'Ddsv6':'Ddsv6', 'Dadsv5 (AMD)':'Dadsv5', 'Dadsv6 (AMD)':'Dadsv6' };
var _MYSQL_BC_GEN: Record<string,string> = { 'Edsv5':'Edsv5', 'Edsv6':'Edsv6', 'Eadsv5 (AMD)':'Eadsv5', 'Eadsv6 (AMD)':'Eadsv6' };
function _mysqlProduct(tier: string, gen: string){
...
REG._svcDefs['Azure Database for MySQL'] = {
  ...
  _applyStepVisibility: function(r){ if (REG['_mysql_applyStepVisibility']) REG['_mysql_applyStepVisibility'](r); },
};

REG['_mysql_applyStepVisibility'] = function(r: Row) {
  var def = REG._svcDefs['Azure Database for MySQL'];
...
REG['_buildDetail_Azure_Database_for_MySQL'] = function(r: Row) {
  var o = r.options || {};
  REG['_mysql_applyStepVisibility'](r);
...
REG['_resolve_Azure_Database_for_MySQL'] = async function(row: Row, cur: string) {
  var o = row.options || {};
  var tier = o.tier || 'Burstable';
  ...
  var ri: RiPair = { ri1:null, ri3:null };
