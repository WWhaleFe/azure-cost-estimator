...
REG['_sqlep_applyStepVisibility'] = function(r) {
...
REG['_buildDetail_Azure_SQL_Database_Elastic_Pool'] = function(r) {
  var o = r.options || {};
...
REG['_resolve_Azure_SQL_Database_Elastic_Pool'] = async function(row, cur) {
  var o = row.options || {};
  var tier = o.tier || 'Standard';
