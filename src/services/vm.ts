...
var _VM_CATEGORY_SERIES: Record<string,string[]> = {
  ...
  '메모리에 최적화':  ['E-series v3','E-series v4','E-series v5','E-series v6','Ed-series v6','Eas-series v5 (AMD)','Eas-series v6 (AMD)','Ead-series v6 (AMD)','E-series v7','Ed-series v7','Eas-series v7 (AMD)','Ead-series v7 (AMD)','M-series'],
