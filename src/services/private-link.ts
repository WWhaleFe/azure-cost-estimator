...
var _PLINK_METER: Record<string, string> = {
...
REG['_buildDetail_Azure_Private_Link'] = function(r: Row) {
  var o = r.options || {};
...
REG['_resolve_Azure_Private_Link'] = async function(row: Row, cur: string) {
  var o = row.options || {};
