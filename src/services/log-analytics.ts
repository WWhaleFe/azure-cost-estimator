...
var _LA_METER: Record<string, string> = {
  'Data Ingestion': 'data ingestion',
  'Data Retention': 'data retention',
  'Data Analyzed':  'data analyzed',
};

REG._svcDefs['Log Analytics'] = {
...
REG['_buildDetail_Log_Analytics'] = function(r: Row) {
  var o = r.options || {};
...
REG['_resolve_Log_Analytics'] = async function(row: Row, cur: string) {
  var o = row.options || {};
