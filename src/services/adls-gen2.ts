...
// ================================================================
REG._svcDefs['Data Lake Storage Gen2'] = {
...
REG['_buildDetail_Data_Lake_Storage_Gen2'] = function(r: Row) {
  var o = r.options || {};
...
REG['_resolve_Data_Lake_Storage_Gen2'] = async function(row: Row, cur: string) {
  var o = row.options || {};
  ...
  var cands = items.filter(function(it: ApiItem){
    ...
    return false;
  }).sort(function(a: ApiItem, b: ApiItem){ var ta=Number(a.tierMinimumUnits||0),tb=Number(b.tierMinimumUnits||0); if(ta!==tb) return ta-tb; return Number(a.unitPrice||0)-Number(b.unitPrice||0); });
