...
REG['_buildDetail_Blob_Storage'] = function(r) {
...
REG['_resolve_Blob_Storage'] = async function(row, cur) {
  const o = row.options || {};
  ...
  cands.sort((a,b)=>{ const ta=Number(a.tierMinimumUnits||0),tb=Number(b.tierMinimumUnits||0); if(ta!==tb) return ta-tb; return Number(a.unitPrice||0)-Number(b.unitPrice||0); });
