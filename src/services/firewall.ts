...
var _FW_METER_SUFFIX: Record<string,string> = {
...
var _FW_METRICS: Record<string,string[]> = {
...
REG['_fw_applyStepVisibility'] = function(r: Row) {
...
REG['_buildDetail_Azure_Firewall'] = function(r: Row) {
  var o = r.options || {};
...
REG['_resolve_Azure_Firewall'] = async function(row: Row, cur: string) {
  var o = row.options || {};
