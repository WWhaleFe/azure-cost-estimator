...
REG._svcDefs['Public IP'] = {
  ...
  _applyStepVisibility: function(r){ if (REG['_pip_applyStepVisibility']) REG['_pip_applyStepVisibility'](r); },
};
...
REG['_pip_applyStepVisibility'] = function(r) {
...
REG['_buildDetail_Public_IP'] = function(r) {
  var o = r.options || {};
...
REG['_resolve_Public_IP'] = async function(row, cur) {
  var o = row.options || {};
