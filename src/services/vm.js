...
REG['_vm_applyStepVisibility'] = function(r) {
...
var VM_INSTANCE_CATALOG = REG.VM_INSTANCE_CATALOG = {
...
var VM_SW_PRODUCT = REG.VM_SW_PRODUCT = {
...
REG['_vmSwLicensePick'] = function(items, vcpu) {
  const bands = [];
...
REG['_vmSwLicenseHourly'] = async function(productName, vcpu, cur) {
...
// detail 빌더
REG['_buildDetail_Virtual_Machine'] = function(r) {
  const o = r.options;
...
// 가격 조회
REG['_resolve_Virtual_Machine'] = async function(row, cur) {
