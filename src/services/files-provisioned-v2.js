...
REG._svcDefs['Azure Files Provisioned v2'] = {
  ...
  rebuildKeys: ['media'],
  _applyStepVisibility: function(r){ if (REG['_fpv2_applyStepVisibility']) REG['_fpv2_applyStepVisibility'](r); },
};

REG['_fpv2_applyStepVisibility'] = function(r) {
...
REG['_buildDetail_Azure_Files_Provisioned_v2'] = function(r) {
  var o = r.options || {};
...
REG['_resolve_Azure_Files_Provisioned_v2'] = async function(row, cur) {
  var o = row.options || {};
