...
REG['_mysql_applyStepVisibility'] = function(r) {
...
REG['_buildDetail_Azure_Database_for_MySQL'] = function(r) {
  var o = r.options || {};
...
REG['_resolve_Azure_Database_for_MySQL'] = async function(row, cur) {
  var o = row.options || {};
  var tier = o.tier || 'Burstable';
