...
var _SQLEP_PRODUCT: Record<string,string> = {
...
var _SQLEP_SIZES: Record<string,string[]> = {
...
REG._svcDefs['Azure SQL Database Elastic Pool'] = {
  ...
  _applyStepVisibility: function(r){ if (REG['_sqlep_applyStepVisibility']) REG['_sqlep_applyStepVisibility'](r); },
};

REG['_sqlep_applyStepVisibility'] = function(r: Row) {
  var def = REG._svcDefs['Azure SQL Database Elastic Pool'];
...
REG['_buildDetail_Azure_SQL_Database_Elastic_Pool'] = function(r: Row) {
  var o = r.options || {};
  REG['_sqlep_applyStepVisibility'](r);
...
REG['_resolve_Azure_SQL_Database_Elastic_Pool'] = async function(row: Row, cur: string) {
  var o = row.options || {};
  var tier = o.tier || 'Standard';
