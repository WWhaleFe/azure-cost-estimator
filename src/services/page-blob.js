...
REG._svcDefs['Page Blob'] = {
  ...
  _applyStepVisibility: function(r){ if (REG['_pageblob_applyStepVisibility']) REG['_pageblob_applyStepVisibility'](r); },
};

REG['_pageblob_applyStepVisibility'] = function(r) {
...
REG['_buildDetail_Page_Blob'] = function(r) {
  var o = r.options || {};
...
REG['_resolve_Page_Blob'] = async function(row, cur) {
  var o = row.options || {};
  var isPrem = (o.performance === 'Premium');
