...
REG._svcDefs['Load Balancer'] = {
  ...
  _applyStepVisibility: function(r){ if (REG['_lb_applyStepVisibility']) REG['_lb_applyStepVisibility'](r); },
};
...
REG['_lb_applyStepVisibility'] = function(r) {
...
REG['_buildDetail_Load_Balancer'] = function(r) {
  var o = r.options || {};
...
REG['_resolve_Load_Balancer'] = async function(row, cur) {
  var o = row.options || {};
