...
REG['_buildDetail_Virtual_Network'] = function(r: Row) {
  var o = r.options || {};
...
REG['_resolve_Virtual_Network'] = async function(row: Row, cur: string) {
  var o = row.options || {};
