...
window._svcDefs['Application Gateway'] = {
  ...
  _applyStepVisibility: function(r){ if (window['_agw_applyStepVisibility']) window['_agw_applyStepVisibility'](r); },
};

// SKU(제품군)에 따라 청구 항목 옵션을 교체하고, 현재 값이 새 목록에 없으면 첫 항목으로 기본 설정
window['_agw_applyStepVisibility'] = function(r) {
  var def = window._svcDefs['Application Gateway'];
