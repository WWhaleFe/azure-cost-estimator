...
window._svcDefs['Azure Synapse Analytics'] = {
  ...
  _applyStepVisibility: function(r){ if (window['_synapse_applyStepVisibility']) window['_synapse_applyStepVisibility'](r); },
};

window['_synapse_applyStepVisibility'] = function(r) {
  var def = window._svcDefs['Azure Synapse Analytics'];
...
window['_buildDetail_Azure_Synapse_Analytics'] = function(r) {
  var o = r.options || {};
  window['_synapse_applyStepVisibility'](r);
  var comp = o.component || 'Dedicated SQL Pool (DWU)';
...
window['_resolve_Azure_Synapse_Analytics'] = async function(row, cur) {
  var o = row.options || {};
  var comp = o.component || 'Dedicated SQL Pool (DWU)';
