...
window._svcDefs['Public IP'] = {
  ...
  _applyStepVisibility: function(r){ if (window['_pip_applyStepVisibility']) window['_pip_applyStepVisibility'](r); },
};
...
window['_pip_applyStepVisibility'] = function(r) {
  var def = window._svcDefs['Public IP'];
