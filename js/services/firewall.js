...
window._svcDefs['Azure Firewall'] = {
  ...
  _applyStepVisibility: function(r){ if (window['_fw_applyStepVisibility']) window['_fw_applyStepVisibility'](r); },
};

window['_fw_applyStepVisibility'] = function(r) {
  var def = window._svcDefs['Azure Firewall'];
