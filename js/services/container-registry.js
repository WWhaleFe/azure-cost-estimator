...
window._svcDefs['Azure Container Registry'] = {
...
window['_buildDetail_Azure_Container_Registry'] = function(r) {
  var o = r.options || {};
  r.skuName = o.tier || '';
...
window['_resolve_Azure_Container_Registry'] = async function(row, cur) {
  var o = row.options || {};
