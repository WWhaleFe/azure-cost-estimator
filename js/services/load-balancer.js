...
window._svcDefs['Load Balancer'] = {
  ...
  _applyStepVisibility: function(r){ if (window['_lb_applyStepVisibility']) window['_lb_applyStepVisibility'](r); },
};
