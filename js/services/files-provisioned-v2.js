...
window._svcDefs['Azure Files Provisioned v2'] = {
  ...
  rebuildKeys: ['media'],
  _applyStepVisibility: function(r){ if (window['_fpv2_applyStepVisibility']) window['_fpv2_applyStepVisibility'](r); },
};

window['_fpv2_applyStepVisibility'] = function(r) {
  var def = window._svcDefs['Azure Files Provisioned v2'];
...
window['_buildDetail_Azure_Files_Provisioned_v2'] = function(r) {
  var o = r.options || {};
  window['_fpv2_applyStepVisibility'](r);
...
window['_resolve_Azure_Files_Provisioned_v2'] = async function(row, cur) {
  var o = row.options || {};
